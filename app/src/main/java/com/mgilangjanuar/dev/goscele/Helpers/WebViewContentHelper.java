...
public class WebViewContentHelper {
    public static void setWebView(WebView webView, String content) {
        webView.loadDataWithBaseURL(null, "<style>body{margin:0;padding:0;word-wrap:break-word;width:100%;}img{display:inline;height:auto;max-width:100%;}</style><body>" + content + "</body>", "text/html", "utf-8", null);
